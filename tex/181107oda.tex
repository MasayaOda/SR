...
プレイヤー2の領地を定義する．
プレイヤーが交互にピボットの色を変える操作を繰り返し，グリッドが2色になったらゲーム終了である(図\ref{twoman})．
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{1回の操作の例．マス目の中の数字は色を表す．図bにも斜線を引く}
		\label{oneman}
	\end{center}
\end{figure}
...
Proceedings of Discrete Applied Math-matics vol. 160, pp. 959--969, 2012.
